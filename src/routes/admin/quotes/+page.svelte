...
<div class="mx-2 lg:mx-8 xs:m-0">
	...
	{#if quotes.length > 0}
		...
		{#if quote.allowed == true}
			<fieldset
				class="mt-2 rounded-xl border-4 border-solid border-slate-100 bg-slate-500 dark:bg-slate-700"
			>
			...
			{:else}
			<fieldset
				class="mt-2 rounded-xl border-4 border-solid border-slate-900 bg-slate-500 dark:bg-slate-700"
			>
				<legend class="mx-5 w-72 text-left text-slate-900 md:w-96"
					><input
						readonly
